...
class MarkdownRendererTest {
    ...
    void headingSelfAnchorIsNestedInsideTheHeadingWithMatchingHref() {
        ...
        // Tolerate block attributes (e.g. data-source-line) the renderer stamps on the <h2>.
        assertTrue(Pattern.compile("<h2 id=\"section-one\"[^>]*><a href=\"#section-one\"").matcher(html).find(),
    ...
    void punctuationOnlyHeadingProducesEmptySlugAndBareFragment() {
        ...
        // Tolerate block attributes (e.g. data-source-line) the renderer stamps on the <h2>.
        assertTrue(Pattern.compile("<h2[^>]*><a href=\"#\">").matcher(result.html()).find(),
